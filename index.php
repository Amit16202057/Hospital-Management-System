    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;"><img src="./assets/images/shafatullah.png" alt="">
...
?>
    ...
    <ul class="listings">
        <li><i class="fa fa-map-marker" aria-hidden="true"></i> Adomjee, Siddhirgonj, Narayangonj, Dhaka</li>
        <li><i class="fa fa-envelope" aria-hidden="true"></i> shafatullah42@gmail.com</li>
        <li><i class="fa fa-phone" aria-hidden="true"></i> +88 01760056645</li>
    </ul>
</div> 
            </div>
